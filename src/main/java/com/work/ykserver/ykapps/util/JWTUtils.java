...
public class JWTUtils {
    ...
    private static final String SECRET = "dY8300olWQ3345;1d<3w48";

    /**
     * 生成JWT （token）
     *
     */
    public static String createJWT(String userInfo, List<String> authorityList) {
        ...
        return JWT.create()
                ...
                .withClaim("authorityList", authorityList)
     ...
     *
     */
    public static String getUserInfoFromJWT(String jwt) {
        try {
            JWTVerifier jwtVerifier = JWT.require(Algorithm.HMAC256(SECRET)).build();
    ...
    public static List<String> getAuthorListFromJWT(String jwt) {
        try {
            JWTVerifier jwtVerifier = JWT.require(Algorithm.HMAC256(SECRET)).build();
            DecodedJWT decodedJWT = jwtVerifier.verify(jwt);
            return decodedJWT.getClaim("authorityList").asList(String.class);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
